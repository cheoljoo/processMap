...
png:
	python3 draw_pm.py --png --input=simple.processmap.json --outdir=spj --plantumlproxyserver=tiger02.lge.com:18080 --plantumlid=cheoljoo.lee --plantumlfileserver=tiger.lge.com --plantumlfileserveruser=auto.tiger --plantumlfileserverpasswd="auto00&89tiger" --plantumlfileserverdirectory=DailyTest/zip-plantuml
